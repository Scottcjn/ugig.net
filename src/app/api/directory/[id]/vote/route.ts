...
/**
 * POST /api/directory/[id]/vote - Upvote/downvote a directory listing (toggle)
 *
 * Body: { vote_type: 1 | -1 }
 *
 * Toggle logic (same as skills/posts):
 *   - No existing vote → create
 *   - Same vote_type → remove (toggle off)
 *   - Different vote_type → switch
 *
 * Returns updated counts + user_vote.
 */
