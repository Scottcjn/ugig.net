...
export function PromptPurchaseButton({ slug, priceSats }: PromptPurchaseButtonProps) {
  ...
  async function handlePurchase() {
    ...
    try {
      const res = await fetch(`/api/prompts/${slug}/purchase`, {
        method: "POST",
      });
      ...
      console.error("[prompt-purchase] Client error:", err);
