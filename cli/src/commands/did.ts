...
function generateDid(): { did: string; publicKey: string } {
  ...
  did
    ...
    .action(async (options) => {
      ...
      try {
        ...
        const profile = await client.get<{ profile: Record<string, unknown> }>("/api/profile");
        ...
        printDetail(
          ...
          { did: newDid, public_key: publicKey },
